...
export class ExpanseActorSheet extends ActorSheet {
	...
	_enrichBio() {
		let enrichment = {};
		enrichment[`system.bio.notes`] = TextEditor.enrichHTML(this.actor.system.bio.notes, {
			async: false,
			relativeTo: this.actor
		});
		enrichment[`system.bio.appearance`] = TextEditor.enrichHTML(this.actor.system.bio.appearance, {
			async: false,
			relativeTo: this.actor
		});
		enrichment[`system.bio.relationships`] = TextEditor.enrichHTML(this.actor.system.bio.relationships, {
			async: false,
			relativeTo: this.actor
		});
		enrichment[`system.bio.goals`] = TextEditor.enrichHTML(this.actor.system.bio.goals, {
			async: false,
			relativeTo: this.actor
		});

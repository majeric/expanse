export class ExpanseItemSheet extends ItemSheet {
	...
	_enrichItem() {
		let enrichment = {};
		enrichment[`system.description`] = TextEditor.enrichHTML(this.item.system.description, {
			async: false,
			relativeTo: this.actor
		});
		if (this.item.type === "talent") {
			enrichment[`system.requirements`] = TextEditor.enrichHTML(this.item.system.requirements, {
				async: false,
				relativeTo: this.actor
			});
			enrichment[`system.ranks.novice.effect`] = TextEditor.enrichHTML(this.item.system.ranks.novice.effect, {
				async: false,
				relativeTo: this.actor
			});
			enrichment[`system.ranks.expert.effect`] = TextEditor.enrichHTML(this.item.system.ranks.expert.effect, {
				async: false,
				relativeTo: this.actor
			});
			enrichment[`system.ranks.master.effect`] = TextEditor.enrichHTML(this.item.system.ranks.master.effect, {
				async: false,
				relativeTo: this.actor
			});
		}
